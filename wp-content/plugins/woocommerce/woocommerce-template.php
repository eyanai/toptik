...
if ( ! function_exists( 'woocommerce_taxonomy_archive_description' ) ) {
	...
	function woocommerce_taxonomy_archive_description() {
		if ( is_tax( array( 'product_cat', 'product_tag' ) ) && get_query_var( 'paged' ) == 0 ) {
			...
			$moreForTitel=is_product_tag()?'מוצרי המותג-':'';
			?><h1 class="page-title toptik"><?php echo $moreForTitel; woocommerce_page_title(); ?></h1>
		<?php if ( $description ) {
...
if ( ! function_exists( 'woocommerce_pagination_end' ) ) {
	...
	function woocommerce_pagination_end() {
		woocommerce_get_template( 'loop/pagination_end.php' );
	}
}
...
if ( ! function_exists( 'woocommerce_show_top_product_images' ) ) {
	 ...
	 * @return void
	 */
	function woocommerce_show_top_product_images() {
		woocommerce_get_template( 'single-product/product-top-image.php' );
	}
}
...
if ( ! function_exists( 'woocommerce_template_toptik' ) ) {

	/**
	 * Output castoum home page.
	 *
	 * @access public
	 * @subpackage	Product
	 * @return void
	 */
	function woocommerce_template_toptik() {
		woocommerce_get_template( 'castoum/homeToptik.php' );
	}
}
if ( ! function_exists( 'woocommerce_template_nosingle_meta' ) ) {
	 ...
	 * @return void
	 */
	function woocommerce_template_nosingle_meta() {
		woocommerce_get_template( 'single-product/mata-nosingel.php' );
	}
}
...
if ( ! function_exists( 'woocommerce_show_product_top_sale_flash' ) ) {
	 ...
	 * @return void
	 */
	function woocommerce_show_product_top_sale_flash() {
		woocommerce_get_template( 'single-product/sale-top-flash.php' );
	}
}
...
if ( ! function_exists( 'woocommerce_breadcrumb' ) ) {
	...
	function woocommerce_breadcrumb( $args = array() ) {
		...
		$defaults = apply_filters( 'woocommerce_breadcrumb_defaults', array(
			'delimiter'   => ' > ',
			'wrap_before' => '<nav class="woocommerce-breadcrumb" itemprop="breadcrumb"><span class="here">הינך נמצא כאן:</span> ',
			'wrap_after'  => '</nav>',
			'before'      => '',
			'after'       => '',

...
if ( ! is_admin() || defined('DOING_AJAX') ) {
	 ...
	 */
	add_action( 'woocommerce_before_main_content', 'woocommerce_breadcrumb', 0, 0 );
	 ...
	 */
	add_action( 'woocommerce_after_single_product_summary', 'woocommerce_output_product_data_toptik', 5 ); 
	...
	add_action( 'woocommerce_single_product_summary', 'woocommerce_template_nosingle_meta', 45 );
	add_action( 'woocommerce_home_toptick', 'woocommerce_template_toptik', 100 );

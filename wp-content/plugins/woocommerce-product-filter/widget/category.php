...
class Woocommerce_product_filter_category extends WP_Widget{
	function __construct(){
		...
		parent::__construct(
			...
			array('description' => __('Woocommerce Product Filter by hierarchical Category. By using this widget you can filter products by categories.', $codenegar_wcpf->text_domain))
		);
	}

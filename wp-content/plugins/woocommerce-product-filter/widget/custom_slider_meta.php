...
class Woocommerce_product_filter_custom_slider_meta extends WP_Widget{
	function __construct(){
		...
		parent::__construct(
			...
			array('description' => __('WooCommerce Product Filter by Custom Meta. By using this widget you can filter products by non-native WooCommerce product meta.', $codenegar_wcpf->text_domain))
		);
	}

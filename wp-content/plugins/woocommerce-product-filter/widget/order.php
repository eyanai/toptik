...
class Woocommerce_product_filter_order extends WP_Widget{
	function __construct(){
		...
		parent::__construct(
			...
			array('description' => __('WooCommerce Product Filter Change Order Widget. By using this widget you can change products order by multiple values.', $codenegar_wcpf->text_domain))
		);
	}

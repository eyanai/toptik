...
class Woocommerce_product_filter_meta extends WP_Widget{
	function __construct(){
		...
		parent::__construct(
			...
			array('description' => __('WooCommerce Product Filter by Meta. By using this widget you can filter products by WordPress post meta.', $codenegar_wcpf->text_domain))
		);
	}

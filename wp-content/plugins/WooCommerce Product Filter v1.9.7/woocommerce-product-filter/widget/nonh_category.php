...
class Woocommerce_product_filter_nonh_category extends WP_Widget{
	function __construct(){
		...
		parent::__construct(
			...
			array('description' => __('Woocommerce Product Filter by Multiple Categories. By using this widget you can filter products by multiple categories at the same time (Non Hierarchical).', $codenegar_wcpf->text_domain))
		);
	}
	...
	public function form($instance){ // Backend widget form
		...
		<p>
			...
			>
				<option <?php if(isset($type) && $type=='list') { echo 'selected="selected"'; } ?>  value="list"><?php _e('List', $codenegar_wcpf->text_domain); ?></option> 
			</select>
		</p>

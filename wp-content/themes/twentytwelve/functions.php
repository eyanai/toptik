...
function twentytwelve_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'top main side bar', 'twentytwelve' ),
		'id' => 'sidebar-1-top',
		'description' => 'בא מעל ל SIDEBAR העיקרי ',
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
...
register_sidebar( array(
		'name' => __( 'באנר קטן- דף הבית', 'twentytwelve' ),
		'id' => 'sidebar-4',
		'description' => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
		'before_title' => '<h3 class="banner_left_home">',
		'after_title' => '</h3>',
	) );
	...
	register_sidebar( array(
		'name' => __( 'באנר קטן אמצעי', 'twentytwelve' ),
		'id' => 'sidebar-5',
		'description' => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
	...
	register_sidebar( array(
		'name' => __( 'באנר בנוני- אמצעי', 'twentytwelve' ),
		'id' => 'sidebar-6',
		'description' => __( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'twentytwelve' ),
		'before_widget' => '<aside id="%1$s" class="widget %2$s">',
		'after_widget' => '</aside>',
...
function toptikSearch(){
?>
	<form role="search" method="get" id="searchform" action="<?php echo esc_url( home_url( '/'  ) ); ?>">
			<div>
				<input type="text" value="<?php echo get_search_query(); ?>" name="s" id="s" class="inTopS" placeholder="<?php _e( 'חפש מוצר', 'woocommerce' ); ?>" />
				<input type="submit" id="searchsubmit" value="" class="inputTop"/>
...
if(!is_admin()){
		wp_register_script('toptik',get_stylesheet_directory_uri()."/js/toptikjs.js",array("jquery"));
		wp_enqueue_script('toptik');
